This project started out as an experiment with using [React Hooks](https://reactjs.org/docs/hooks-intro.html) to create and control sounds using the WebAudio API, and more specifically, `OscillatorNode`s.
